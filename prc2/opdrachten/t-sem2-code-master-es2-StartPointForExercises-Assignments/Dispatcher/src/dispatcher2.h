...
// - a uint32_t repetitiontime : this time indicates the time between consecutive calls of the functionpointer.
//
...
// pre : timerId != null, dispatcher initialized
// post: dispatcherelement ponted to with timerId has status free.
// returns :
//   0 : succes,
//   -1: fail
